...
object ActionsThns {
  ...
  // ---------------------------------------------------------------------------
  //TODO: if optional?
  case class ThnUU(f: HeadU => HeadU) extends ActionUU11 {
    ...
    // ---------------------------------------------------------------------------
    case class ThnZZ(f: HeadZ => HeadZ) extends ActionZZ11 {
  ...
  // ===========================================================================
  case class ThnUZ(f: HeadU => HeadZ) extends ActionUZ11 {
    ...
    // ---------------------------------------------------------------------------
    case class ThnZU(f: HeadZ => HeadU) extends ActionZU11 {
  ...
  // ===========================================================================
  case class ThnUV[V: WTT](f: HeadU => HeadV[V]) extends ActionUV11b {
    ...
    // ---------------------------------------------------------------------------
    case class ThnZV[V: WTT](f: HeadZ => HeadV[V]) extends ActionZV11b {
