...
object ActionsCommonFusion { import ActionsUtils.removeAll
  ...
  // ===========================================================================
  case class Fuse2(from: TtqKPath2, to: TKPath, f: _ff21) extends ActionUU1N {
  ...
  case class FusionWV2a(from: TqKPath2, to: KPath, f: _ff21) extends ActionUU1N {
    ...
    // ---------------------------------------------------------------------------    
    case class FusionWV3a(from: TqKPath3, to: KPath, f: _ff31) extends ActionUU1N {
        def  vldt(c: Cls): Errs = from.vldtAsOrigin(c) ++ to.vldtAsNewDestination(c)
  ...
  // ===========================================================================
  case class FusionWV2b(from: TqKPath2, to: KPath, toType: TypeNode, f: _ff21) extends ActionUU1N {
    ...
    // ---------------------------------------------------------------------------
    case class FusionWV3b(from: TqKPath3, to: KPath, toType: TypeNode, f: _ff31) extends ActionUU1N {
      def vldt(c: Cls): Errs = from.vldtAsOrigin(c) ++ to.vldtAsNewDestination(c) ++ _vldt.validType(toType)
