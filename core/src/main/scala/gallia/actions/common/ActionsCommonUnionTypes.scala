...
object ActionsCommonUnionTypes {
  ...
  case class FuseToUnion(origin1: Key, origin2: Key, dest: Key) extends ActionUU01 {
    ...
    case class FissionFromUnion(origin: Key, dest1: Key, dest2: Key) extends ActionUU11 {
