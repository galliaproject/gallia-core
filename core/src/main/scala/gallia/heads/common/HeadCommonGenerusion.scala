  ...
  class _Generusion(d: KPath)  {
    ...
    def from[O1: WTT, O2: WTT, O3: WTT, O4: WTT, O5: WTT, O6: WTT, O7: WTT, O8: WTT](f1: Generate2[O1], f2: Generate2[O2], f3: Generate2[O3], f4: Generate2[O4], f5: Generate2[O5], f6: Generate2[O6], f7: Generate2[O7], f8: Generate2[O8]) = new Generate1From8(f1, f2, f3, f4, f5, f6, f7, f8)
      ...
      class _FromU1(f1: Generate1[HeadU]) {
        ...
        def using         (f: HeadU => HeadZ)    (implicit d1: DI)        : Self2 = ??? /* TODO: t210202164324 */
        def using[V1: WTT](f: HeadU => HeadV[V1])(implicit d1: DI, d2: DI): Self2 = ??? /* TODO: t210202164324 */ }
      ...
      class _FromZ1(f1: Generate1[HeadZ]) {
        ...
        def using         (f: HeadZ => HeadU)                             : Self2 = ??? /* TODO: t210202164324 */
        def using[V1: WTT](f: HeadZ => HeadV[V1])(implicit d1: DI, d2: DI): Self2 = ??? /* TODO: t210202164324 */ }
      ...
      class _FromV1[O: WTT](f1: Generate1[O]) {
        def using        (f: O => HeadU)                         : Self2 = ??? /* TODO: t210202164324 */
        def using        (f: O => HeadZ)(implicit d1: DI)        : Self2 = ??? /* TODO: t210202164324 */
