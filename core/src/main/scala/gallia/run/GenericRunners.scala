...
private[gallia] class GenericRunnerO(writing: AObj => Unit) {
    ...
    def run(head: HeadO): Unit =
      ...
      // ---------------------------------------------------------------------------
      object GenericRunnerOutputU extends actions.boilerplate.ActionBoilerplate.ActionUO11 with IdentityVM1 {
  ...
  private[gallia] class GenericRunnerZ(writing: AObjs => Unit) {
    ...
    def run(head: HeadS): Unit =
      ...
      // ---------------------------------------------------------------------------
      object GenericRunnerOutputZ extends actions.boilerplate.ActionBoilerplate.ActionZO11 with IdentityVM1 {
