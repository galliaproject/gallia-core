...
object FunctionWrappers {
  ...
  type _pp81 = (Any, Any, Any, Any, Any, Any, Any) => Boolean
  ...
  @inline private[gallia]   def pwrap  [O1](f: O1 => Boolean): _pp11 = f.asInstanceOf[_pp11]
    ...
    @inline private[gallia] def pwrap61[O1, O2, O3, O4, O5, O6, O7, O8](f: (O1, O2, O3, O4, O5, O6)         => Boolean): _pp61 = f.asInstanceOf[_pp61]
    @inline private[gallia] def pwrap71[O1, O2, O3, O4, O5, O6, O7, O8](f: (O1, O2, O3, O4, O5, O6, O7)     => Boolean): _pp71 = f.asInstanceOf[_pp71]
