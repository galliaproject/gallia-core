...
object AtomsUUTransforms {
  ...
  case class _Transform6to1(ori: PathPair6, des: KPaths1, f: _ff61) extends AtomUU { def naive(o: Obj): Obj = ori.lookup(o).thn(f.tupled).thn { v1 => o.put(des, v1) } }
  case class _Transform7to1(ori: PathPair7, des: KPaths1, f: _ff71) extends AtomUU { def naive(o: Obj): Obj = ori.lookup(o).thn(f.tupled).thn { v1 => o.put(des, v1) } }
  case class _Transform8to1(ori: PathPair8, des: KPaths1, f: _ff81) extends AtomUU { def naive(o: Obj): Obj = ori.lookup(o).thn(f.tupled).thn { v1 => o.put(des, v1) } }
