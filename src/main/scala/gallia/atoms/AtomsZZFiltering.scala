...
object AtomsZZFiltering {
  ...
  // ===========================================================================
  case class _TakeWhile(pred: Obj => Boolean) extends AtomZZ { def naive(z: Objs) = z.takeWhile(pred) }
  case class _DropWhile(pred: Obj => Boolean) extends AtomZZ { def naive(z: Objs) = z.dropWhile(pred) }
}
