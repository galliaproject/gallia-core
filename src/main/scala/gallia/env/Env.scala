...
// ===========================================================================
private[gallia] class Env(idPrefix: String = "") {
  ...
  // ---------------------------------------------------------------------------
  private[gallia] def nextDagId (): DagId  = synchronized { dagId   += 1; dagId  .toString.padLeft(6, '0').prepend("G").prepend(idPrefix) }
  private[gallia] def nextNodeId(): NodeId = synchronized { nodeId  += 1; nodeId .toString.padLeft(9, '0').prepend("N").prepend(idPrefix) }
