...
trait HeadUSquashing { ignored: HeadU => // TODO: t210122161652 - favor AtomsVO now?
  ...
  def squash[O1: WTT                                    ](f1: Squash[O1])                                                                 = new { def using[D1: WTT](f:  O1                  => D1): HeadV[D1] = uv(SquashU1(resolve (f1                ), typeNode[D1], wrap11(f))) } // = grab
  def squash[O1: WTT, O2: WTT                           ](f1: Squash[O1], f2: Squash[O2])                                                 = new { def using[D1: WTT](f: (O1, O2)             => D1): HeadV[D1] = uv(SquashU2(resolve2(f1, f2            ), typeNode[D1], wrap21(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT                  ](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3])                                 = new { def using[D1: WTT](f: (O1, O2, O3)         => D1): HeadV[D1] = uv(SquashU3(resolve3(f1, f2, f3        ), typeNode[D1], wrap31(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT, O4: WTT         ](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3], f4: Squash[O4])                 = new { def using[D1: WTT](f: (O1, O2, O3, O4)     => D1): HeadV[D1] = uv(SquashU4(resolve4(f1, f2, f3, f4    ), typeNode[D1], wrap41(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT, O4: WTT, O5: WTT](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3], f4: Squash[O4], f5: Squash[O5]) = new { def using[D1: WTT](f: (O1, O2, O3, O4, O5) => D1): HeadV[D1] = uv(SquashU5(resolve5(f1, f2, f3, f4, f5), typeNode[D1], wrap51(f))) }
...
trait HeadZSquashing { ignored: HeadZ =>
  ...
  def squash[O1: WTT                                    ](f1: Squash[O1])                                                                 = new { def using[D1: WTT](f: Seq[ O1 ]                 => D1): HeadV[D1] = zv(SquashZ1(resolve (f1                ), typeNode[D1], awrap11(f))) } // = grab
  def squash[O1: WTT, O2: WTT                           ](f1: Squash[O1], f2: Squash[O2])                                                 = new { def using[D1: WTT](f: Seq[(O1, O2)]             => D1): HeadV[D1] = zv(SquashZ2(resolve2(f1, f2            ), typeNode[D1], awrap21(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT                  ](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3])                                 = new { def using[D1: WTT](f: Seq[(O1, O2, O3)]         => D1): HeadV[D1] = zv(SquashZ3(resolve3(f1, f2, f3        ), typeNode[D1], awrap31(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT, O4: WTT         ](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3], f4: Squash[O4])                 = new { def using[D1: WTT](f: Seq[(O1, O2, O3, O4)]     => D1): HeadV[D1] = zv(SquashZ4(resolve4(f1, f2, f3, f4    ), typeNode[D1], awrap41(f))) }
  def squash[O1: WTT, O2: WTT, O3: WTT, O4: WTT, O5: WTT](f1: Squash[O1], f2: Squash[O2], f3: Squash[O3], f4: Squash[O4], f5: Squash[O5]) = new { def using[D1: WTT](f: Seq[(O1, O2, O3, O4, O5)] => D1): HeadV[D1] = zv(SquashZ5(resolve5(f1, f2, f3, f4, f5), typeNode[D1], awrap51(f))) }
