...
trait HeadCommonFission[F <: HeadCommon[F]] { ignored: HeadCommon[F] =>
  ...
  def fission(o: KPathW): _FromWhatever = new _FromWhatever(_._explicit(o.value))
    ...
    class _FromWhatever(o: Fission[WV]) {
      ...
      // ---------------------------------------------------------------------------
      def as(d1: KPathW, d2: KPathW) = new _As2(d1, d2)
       final class _As2 private[heads] (d1: KPathW, d2: KPathW) {
      ...
      // ---------------------------------------------------------------------------
      def as(d1: KPathW, d2: KPathW, d3: KPathW) = new _As3(d1, d2, d3)
       final class _As3 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW) {
        // TODO: t210816120207 - should this also abstract multiplicity?
  ...
  // ===========================================================================
  @Max10
  def fission[O1: WTT](o1: Fission[O1]) = new _Fission(o1)
   final class _Fission[O1: WTT] private[heads] (o1: Fission[O1]) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW) = new _As4(d1, d2, d3, d4)
     final class _As4 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW) = new _As5(d1, d2, d3, d4, d5)
     final class _As5 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW) = new _As6(d1, d2, d3, d4, d5, d6)
     final class _As6 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW) = new _As7(d1, d2, d3, d4, d5, d6, d7)
     final class _As7 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW) = new _As8(d1, d2, d3, d4, d5, d6, d7, d8)
     final class _As8 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW, d9: KPathW) = new _As9(d1, d2, d3, d4, d5, d6, d7, d8, d9)
     final class _As9 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW, d9: KPathW) {
    ...
    // ---------------------------------------------------------------------------
    def as(d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW, d9: KPathW, d10: KPathW) = new _As10(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10)
     final class _As10 private[heads] (d1: KPathW, d2: KPathW, d3: KPathW, d4: KPathW, d5: KPathW, d6: KPathW, d7: KPathW, d8: KPathW, d9: KPathW, d10: KPathW) {
