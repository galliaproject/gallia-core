...
// ===========================================================================
sealed trait IntegerLikeType extends NumericalType {
...
// ===========================================================================
sealed trait NumericalType extends BasicType // integers + reals
...
sealed trait BasicType // TODO: t210125111338 - investigate union types (coming in scala 3?)
  ...
  @TypeMatching object BasicType extends Enum[BasicType] {
    ...
    // ---------------------------------------------------------------------------
    case object _BigInt        extends IntegerLikeType { type T = BigInt    ; val fullName = "scala.math.BigInt"    ; /* boilerplate: */ override lazy val ctag: ClassTag[T] = classTag[T]; override lazy val nctag: ClassTag[Iterable[T]] = classTag[Iterable[T]]; override lazy val octag: ClassTag[Option [T]] = classTag[Option [T]]; override lazy val pctag: ClassTag[Option[Iterable[T]]] = classTag[Option[Iterable[T]]]; override lazy val ordA: Ordering[T] = implicitly[Ordering[T]]; override lazy val ordD: Ordering[T] = implicitly[Ordering[T]].reverse; def toIntegerLike(value: Double) = BigInt(value.toLong) }
