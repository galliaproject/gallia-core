...
class SuccessResult[$Data](
  ...
  case class SuccessResultZ   (override val meta: SuccessMetaResult, override val data: Objs) extends SuccessResult[Objs](meta, data) { def aobjs: AObjs = AObjs(meta.forceLeafClass, data._asViewBased) }
