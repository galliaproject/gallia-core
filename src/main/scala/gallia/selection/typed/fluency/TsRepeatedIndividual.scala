...
object TsRepeatedIndividual {
  ...
  trait HasRepeatedOneBigDec[$Wrap, $Wrapz <: Seq[$Wrap]] { def bigDec(x1: $Wrap, x2: $Wrap, more: $Wrap*) = new One_[BigDec]((x1, x2, more)) }
  ...
  trait HasRepeatedOptBigDec[$Wrap, $Wrapz <: Seq[$Wrap]] { def bigDec_(x1: $Wrap, x2: $Wrap, more: $Wrap*) = new Opt_[BigDec]((x1, x2, more)) }
  ...
  trait HasRepeatedNesBigDec[$Wrap, $Wrapz <: Seq[$Wrap]] { def bigDecs(x1: $Wrap, x2: $Wrap, more: $Wrap*) = new Nes_[BigDec]((x1, x2, more)) }
  ...
  trait HasRepeatedPesBigDec[$Wrap, $Wrapz <: Seq[$Wrap]] { def bigDecs_(x1: $Wrap, x2: $Wrap, more: $Wrap*) = new Pes_[BigDec]((x1, x2, more)) }
  ...
  trait HasRepeatedXBigDec[$Wrap, $Wrapz <: Seq[$Wrap]] { def bigDecx(x1: $Wrap, x2: $Wrap, more: $Wrap*) = new One_[BigDec]((x1, x2, more), ignoreContainer = true) }
