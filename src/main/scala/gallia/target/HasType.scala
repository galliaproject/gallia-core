...
trait HasType extends HasTypeNode with HasTypeSeq {
    ...
    def wrapc(that: HasTypes9  , f: _ff19): _ff19 = x => { val (y1, y2, y3, y4, y5, y6, y7, y8, y9)     = f(this.in(x)); (that.ht1.out(y1), that.ht2.out(y2), that.ht3.out(y3), that.ht4.out(y4), that.ht5.out(y5), that.ht6.out(y6), that.ht7.out(y7), that.ht8.out(y8), that.ht9.out(y9)) }
    def wrapc(that: HasTypes10 , f: _ff1A): _ff1A = x => { val (y1, y2, y3, y4, y5, y6, y7, y8, y9, yA) = f(this.in(x)); (that.ht1.out(y1), that.ht2.out(y2), that.ht3.out(y3), that.ht4.out(y4), that.ht5.out(y5), that.ht6.out(y6), that.ht7.out(y7), that.ht8.out(y8), that.ht9.out(y9), that.ht10.out(yA)) }
  ...
  trait HasTypes9 extends HasTypeSeq {
    ...
    def wrapc(thatHt: HasTypeNode, f: _ff91): _ff91 = (x1, x2, x3, x4, x5, x6, x7, x8, x9) => thatHt.out( f(ht1.in(x1), ht2.in(x2), ht3.in(x3), ht4.in(x4), ht5.in(x5), ht6.in(x6), ht7.in(x7), ht8.in(x8), ht9.in(x9)) ) }
  ...
  trait HasTypes10 extends HasTypeSeq {
    ...
    def wrapc(thatHt: HasTypeNode, f: _ffA1): _ffA1 = (x1, x2, x3, x4, x5, x6, x7, x8, x9, x10) => thatHt.out( f(ht1.in(x1), ht2.in(x2), ht3.in(x3), ht4.in(x4), ht5.in(x5), ht6.in(x6), ht7.in(x7), ht8.in(x8), ht9.in(x9), ht10.in(x10)) ) }
